...
DefinitionBlock ("", "SSDT", 2, "ACDT", "BAT1", 0)
{
    ...
    External(_SB.PCI0.LPCB.EC.BAT1.XBIF, MethodObj)
    External(_SB.PCI0.LPCB.EC.BAT1.XBST, MethodObj)
    External(_SB.PCI0.LPCB.EC.BAT1.POSW, MethodObj)
    External(_SB.PCI0.LPCB.EC.ECAV, IntObj)
    External(_SB.PCI0.LPCB.EC.B1IC, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.B1DI, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.ECRD, MethodObj)
    ...
    Scope(_SB.PCI0.LPCB.EC.BAT1)
    {
        Method (_BIF, 0, Serialized)
        {
                ...
                Else
                {
                    Return (\_SB.PCI0.LPCB.EC.BAT1.XBIF())
                }
        }
        ...
        Method (_BST, 0, Serialized)
        {
                ...
                Else
                {
                    Return (\_SB.PCI0.LPCB.EC.BAT1.XBST())
                }
        }
    }
}
